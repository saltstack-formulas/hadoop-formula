...
{%- set default_versions = { 'apache-1.2.1' : { 'version'       : '1.2.1',
                     ...
                     'apache-2.8.3' : { 'version'       : '2.8.3',
                                        ...
                                        'source_url'    : g.get('source_url', p.get('source_url', 'http://apache.osuosl.org/hadoop/common/hadoop-2.8.3/hadoop-2.8.3-src.tar.gz')),
                                        'source_hash'   : g.get('source_hash', p.get('source_hash', 'e53d04477b85e8b58ac0a26468f04736')),
                                        'major_version' : '2',
                                      },  
